...
<footer class="footer">
    <div class="container">
        <div class="row align-items-center flex-row-reverse">
            <!-- <div class="col-md-12 col-sm-12 text-center"> Copyright © 2022 <a href="#"></a>. Designed with <span class="fa fa-heart text-danger"></span> by <a href="#"> </a> All rights reserved. </div> -->
            <div class="col-md-12 col-sm-12 text-center"> Copyright © 2022 <a href="#"></a>. All rights reserved. </div>
        </div>
    </div>
</footer> <!-- FOOTER END -->
</div>
...
<form class="ff_fileupload_hidden" action="" method="post" enctype="multipart/form-data"><input type="hidden" name="action" value="fileuploader"><input type="file" name="files" multiple="" accept=".jpg, .png, image/jpeg, image/png"></form>
