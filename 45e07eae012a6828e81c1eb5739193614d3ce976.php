                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            &nbsp; &nbsp;<a href="<?php echo e(route('admin.gallery.index',@$query)); ?>" title="Refesh" class="btn btn-success text-right"><i class="fa fa-refresh"></i></a>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <form class="needs-validation">
                                    <div class="d-flex">
                                        ...
                                        <div style="margin-right: 10px;"><a href="<?php echo e(route('admin.gallery.index')); ?>" class="btn btn-danger" style="background-color: #e74c3c;">Clear All</a></div>
                                    </div>
                                </form>
                                <table class="table border text-nowrap text-md-nowrap table-bordered mb-0 mt-5">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo e($list->name ? $list->name : 'N/A'); ?></td>
                                            <td>
                                                <!-- <div class="d-flex"> -->
                                                <span class="avatar bradius" style="background-image: url('<?php echo e(url('storage/gallery',$list->image)); ?>');"></span>
                                                <!-- </div> -->
                                            </td>
                                            <td>
                                                <div class="mt-sm-1 d-block">
                                                    <?php if($list->status == 'true'): ?>
                                                    <a href="#" data-url="<?php echo e(route('admin.gallery.status',$list->id)); ?>" id="single_status">
                                                        <span class="badge bg-success-transparent rounded-pill text-success p-2 px-3">True</span>
                                                    </a>
                                                    <?php else: ?>
                                                    <a href="#" data-url="<?php echo e(route('admin.gallery.status',$list->id)); ?>" id="single_status">
                                                        <span class="badge bg-danger-transparent rounded-pill text-warning p-2 px-3">False</span>
                                                    </a>
                                                    <?php endif; ?>
                                                </div>
                                            </td>
                                            <td><?php echo e($list->description ? $list->description : 'N/A'); ?></td>
                                            <td>
                                                <div class="btn-list">
                                                    <a href="<?php echo e(route('admin.gallery.edit',$list->id)); ?>" class="btn btn-sm btn-primary">
                                                        <span class="fe fe-edit"> </span>
                                                    </a>
                                                    <a href="#" data-url="<?php echo e(route('admin.gallery.delete',$list->id)); ?>" id="single_delete" class="btn btn-sm btn-danger">
...
<?php $__env->stopSection(); ?><?php /**PATH /home2/vijaycku/public_html/resources/views/backend/inc/gallery/list.blade.php ENDPATH**/ ?>