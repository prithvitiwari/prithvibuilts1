                                        ...
                                        <div class="product-grid6">
                                            ...
                                            <div class="card-body pt-0">
                                                <div class="product-content text-center">
                                                    <h1 class="title fw-bold fs-20"><a href="<?php echo e(route('admin.user.checkout',[$user->id,$list->id])); ?>"><?php echo e($list->name); ?></a></h1>
                                                    ...
                                                    <div class="price">₹<?php echo e($list->price); ?> /-
                                            ...
                                            <div class="card-footer text-center">
                                                <a href="#" data-url="<?php echo e(route('admin.user.checkout',[$user->id,$list->id])); ?>" class="btn btn-primary mb-1 buyPackage"><i class="fe fe-shopping-cart me-2"></i>Buy Now</a>
...
<?php $__env->stopSection(); ?><?php /**PATH /home2/vijaycku/public_html/resources/views/backend/inc/user/package.blade.php ENDPATH**/ ?>