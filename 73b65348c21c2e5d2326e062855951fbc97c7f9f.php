                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            &nbsp; &nbsp;<a href="<?php echo e(route('admin.news.index',@$query)); ?>" title="Refesh" class="btn btn-success text-right"><i class="fa fa-refresh"></i></a>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <form class="needs-validation">
                                    <div class="d-flex">
                                        ...
                                        <div style="margin-right: 10px;"><a href="<?php echo e(route('admin.news.index')); ?>" class="btn btn-danger" style="background-color: #e74c3c;">Clear All</a></div>
                                    </div>
                                </form>
                                <table class="table border text-nowrap text-md-nowrap table-bordered mb-0 mt-5">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <span class="avatar bradius" style="background-image: url('<?php echo e(url('storage/news',$list->image)); ?>');"></span>
                                                </div>
                                            </td>
                                            <td><?php echo e(date('d M Y', strtotime($list->start_date))); ?>

                                                <?php if($list->end_date): ?>
                                                - <?php echo e(date('d M Y', strtotime($list->end_date))); ?>
                                            ...
                                            <td>
                                                <div class="mt-sm-1 d-block">
                                                    ...
                                                    <a href="#" data-url="<?php echo e(route('admin.news.status',$list->id)); ?>" id="single_status">
                                            ...
                                            <td>
                                                <div class="btn-list">
                                                    <a href="<?php echo e(route('admin.news.edit',$list->id)); ?>" class="btn btn-sm btn-primary">
                                                        <span class="fe fe-edit"> </span>
                                                    </a>
                                                    <a href="#" data-url="<?php echo e(route('admin.news.delete',$list->id)); ?>" id="single_delete" class="btn btn-sm btn-danger">
                                                        <span class="fe fe-trash-2"> </span>
                                                    </a>
                                                    <a href="<?php echo e(route('admin.news.show',$list->id)); ?>" class="btn btn-sm btn-warning">
...
<?php $__env->stopSection(); ?><?php /**PATH /home2/vijaycku/public_html/resources/views/backend/inc/news/list.blade.php ENDPATH**/ ?>