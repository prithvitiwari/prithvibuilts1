                                    ...
                                    <div class="card">
                                        <div class="product-grid6">
                                            <div class="product-image6 p-5">
                                                ...
                                                <a href="<?php echo e(route('user.product.detail',$list->slug)); ?>" class="bg-light">
                                            ...
                                            <div class="card-body pt-0">
                                                <div class="product-content text-center">
                                                    <h1 class="title fw-bold fs-20"><a href="<?php echo e(route('user.product.detail',$list->slug)); ?>"><?php echo e($list->name); ?></a></h1>
                                            ...
                                            <div class="card-footer text-center">
                                                <a href="javascript:void(0)" data-url="<?php echo e(route('user.cart.store',$list->id)); ?>" class="btn btn-primary mb-1 add_cart"><i class="fe fe-shopping-cart me-2"></i>Buy Now</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layout.usermaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/vijaycku/public_html/resources/views/frontend/inc/user/product.blade.php ENDPATH**/ ?>