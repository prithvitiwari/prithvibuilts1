    ...
    <div class="">
        ...
        <div class="container-login100">
            <div class="wrap-login100 p-6">
                ...
                <form class="login100-form validate-form login100-form-register kycSubmit" method="POST" files="true" enctype="multipart/form-data" action="<?php echo e(route('auth.userverify_otp',$user->id)); ?>">
...
<?php $__env->stopSection(); ?><?php /**PATH /home2/vijaycku/public_html/resources/views/frontend/inc/verifyuser.blade.php ENDPATH**/ ?>