...
<head>
    <title>Otp for your {{ $setting->site_name }} account wallet amount transfer</title>
</head>
...
<body>
    <div style="font-family: Helvetica,Arial,sans-serif;min-width:1000px;overflow:auto;line-height:2;">
        <div style="margin:50px auto;width:70%;padding:20px 20px; background-color:#f1f2f2;">
            ...
            <p>Use the following one-time password (OTP) to wallet amount transfer to your {{ $setting->site_name }} account. This OTP will be valid for 15 minutes.</p>
