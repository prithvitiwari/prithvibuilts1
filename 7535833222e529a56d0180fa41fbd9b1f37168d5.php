    ...
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            ...
            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-8">
                                    <div class="card-body p-4" style="color: #282f53;">
                                        <h2 class="mb-2 fw-normal mt-2"><?php echo e(number_format($total_users)); ?></h2>
                ...
                <div class="col-sm-12 col-lg-6 col-md-12 col-xl-3">
                    <div class="card">
                        <a href="<?php echo e(route('admin.user.index')); ?>?limit=10&date=<?php echo e($today); ?>">
                            <div class="row">
                                <div class="col-4">
                                ...
                                <div class="col-8">
                                    <div class="card-body p-4" style="color: #282f53;">
                                        <h2 class="mb-2 fw-normal mt-2"><?php echo e(number_format($today_total_users)); ?></h2>
                ...
                <div class="col-sm-12 col-lg-6 col-md-12 col-xl-3">
                    <div class="card">
                        <a href="<?php echo e(route('admin.user.index')); ?>?limit=10&package=true&date=<?php echo e($today); ?>">
                            <div class="row">
                                <div class="col-4">
                                ...
                                <div class="col-8">
                                    <div class="card-body p-4" style="color: #282f53;">
                                        <h2 class="mb-2 fw-normal mt-2"><?php echo e(number_format($today_active_users)); ?></h2>
                ...
                <div class="col-sm-12 col-lg-6 col-md-12 col-xl-3">
                    <div class="card">
                        <a href="<?php echo e(route('admin.user.index')); ?>?limit=10&package=false&date=<?php echo e($today); ?>">
                            <div class="row">
                                <div class="col-4">
                                ...
                                <div class="col-8">
                                    <div class="card-body p-4" style="color: #282f53;">
                                        <h2 class="mb-2 fw-normal mt-2"><?php echo e(number_format($today_deactive_users)); ?></h2>
                ...
                <div class="col-sm-12 col-lg-6 col-md-12 col-xl-3">
                    <div class="card">
                        <a href="<?php echo e(route('admin.user.index')); ?>?limit=10&package=true">
                            <div class="row">
                                <div class="col-4">
                                ...
                                <div class="col-8">
                                    <div class="card-body p-4" style="color: #282f53;">
                                        <h2 class="mb-2 fw-normal mt-2"><?php echo e(number_format($buy_package_members)); ?></h2>
                ...
                <div class="col-sm-12 col-lg-6 col-md-12 col-xl-3">
                    <div class="card">
                        <a href="<?php echo e(route('admin.user.index')); ?>?limit=10&package=false">
                            <div class="row">
                                <div class="col-4">
                                ...
                                <div class="col-8">
                                    <div class="card-body p-4" style="color: #282f53;">
                                        <h2 class="mb-2 fw-normal mt-2"><?php echo e(number_format($not_buy_package_members)); ?></h2>
                ...
                <div class="col-sm-12 col-lg-6 col-md-12 col-xl-3">
                    <div class="card">
                        <a href="<?php echo e(route('admin.user.index')); ?>?limit=10&status=true">
                            <div class="row">
                                <div class="col-4">
                                ...
                                <div class="col-8">
                                    <div class="card-body p-4" style="color: #282f53;">
                                        <h2 class="mb-2 fw-normal mt-2"><?php echo e(number_format($active_members->count())); ?></h2>
                ...
                <div class="col-sm-12 col-lg-6 col-md-12 col-xl-3">
                    <div class="card">
                        <a href="<?php echo e(route('admin.user.index')); ?>?limit=10&status=false">
                            <div class="row">
                                <div class="col-4">
                                ...
                                <div class="col-8">
                                    <div class="card-body p-4" style="color: #282f53;">
                                        <h2 class="mb-2 fw-normal mt-2"><?php echo e(number_format($deactive_members->count())); ?></h2>
                    ...
                    <div class="card">
                        <a href="<?php echo e(route('admin.order')); ?>">
                            <div class="row">
                                ...
                                <div class="col-8">
                                    <div class="card-body p-4" style="color: #282f53;">
                                        <h2 class="mb-2 fw-normal mt-2"><?php echo e(number_format($orders)); ?></h2>
                    ...
                    <div class="card">
                        <a href="<?php echo e(route('admin.product.index')); ?>">
                            <div class="row">
                                ...
                                <div class="col-8">
                                    <div class="card-body p-4" style="color: #282f53;">
                                        <h2 class="mb-2 fw-normal mt-2"><?php echo e(number_format($products)); ?></h2>
                ...
                <div class="col-sm-12 col-lg-4 col-md-12 col-xl-3">
                    <div class="card">
                        <a href="<?php echo e(route('admin.kit.index')); ?>">
                            <div class="row">
                                <div class="col-4">
                                    <div class="circle-icon bg-danger text-center align-self-center box-primary-shadow bradius">
                                        <img src="<?php echo e(url('assets/images/svgs/circle.svg')); ?>" alt="img" class="card-img-absolute">
                                ...
                                <div class="col-8">
                                    <div class="card-body p-4" style="color: #282f53;">
                                        <h2 class="mb-2 fw-normal mt-2"><?php echo e(number_format($kits)); ?></h2>
                    ...
                    <div class="card">
                        <a href="<?php echo e(route('admin.blog.index')); ?>">
                            <div class="row">
                                ...
                                <div class="col-8">
                                    <div class="card-body p-4" style="color: #282f53;">
                                        <h2 class="mb-2 fw-normal mt-2"><?php echo e(number_format($blogs)); ?></h2>
                    ...
                    <div class="card">
                        <a href="<?php echo e(route('admin.news.index')); ?>">
                            <div class="row">
                                ...
                                <div class="col-8">
                                    <div class="card-body p-4" style="color: #282f53;">
                                        <h2 class="mb-2 fw-normal mt-2"><?php echo e(number_format($news)); ?></h2>
                ...
                <div class="col-sm-12 col-lg-4 col-md-12 col-xl-3">
                    <div class="card">
                        <a href="<?php echo e(route('admin.enquery.index')); ?>">
                            <div class="row">
                                <div class="col-4">
                                    <div class="circle-icon bg-primary text-center align-self-center box-primary-shadow bradius">
                                        <img src="<?php echo e(url('assets/images/svgs/circle.svg')); ?>" alt="img" class="card-img-absolute">
                                ...
                                <div class="col-8">
                                    <div class="card-body p-4" style="color: #282f53;">
                                        <h2 class="mb-2 fw-normal mt-2"><?php echo e(number_format($enquery)); ?></h2>
                    ...
                    <div class="card">
                        <a href="<?php echo e(route('admin.support.index')); ?>">
                            <div class="row">
                                ...
                                <div class="col-8">
                                    <div class="card-body p-4" style="color: #282f53;">
                                        <h2 class="mb-2 fw-normal mt-2"><?php echo e(number_format($support)); ?></h2>
...
<?php $__env->stopSection(); ?><?php /**PATH /home2/vijaycku/public_html/resources/views/backend/inc/dashboard.blade.php ENDPATH**/ ?>