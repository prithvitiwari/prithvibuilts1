...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(url('storage/favicon',$site_details->favicon)); ?>"> <!-- TITLE -->
    <meta name="_token" content="<?php echo e(csrf_token()); ?>">
    <title>Admin Panel - <?php echo e($title); ?></title> <!-- BOOTSTRAP CSS -->
    ...
    <!--- FONT-ICONS CSS -->
    <link href="<?php echo e(url('assets/plugins/fancyuploader/fancy_fileupload.css')); ?>" rel="stylesheet">
    ...
    <div class="horizontalMenucontainer">
        ...
        <div class="page">
            <div class="page-main">
                ...
                <div class="app-header header sticky" style="margin-bottom: -74px;">
                    <div class="container-fluid main-container">
                        <div class="d-flex"> <a aria-label="Hide Sidebar" class="app-sidebar__toggle" data-bs-toggle="sidebar" href="#"></a> <!-- sidebar-toggle-->
                            <a class="logo-horizontal " href="<?php echo e(route('admin.dashboard')); ?>">
                                <img src="<?php echo e(url('storage/logo',$site_details->logo)); ?>" style="width: 100px;" class="header-brand-img desktop-logo" alt="logo">
                                <img src="<?php echo e(url('storage/logo',$site_details->logo)); ?>" style="width: 100px;" class="header-brand-img light-logo1" alt="logo">
                            </a> <!-- LOGO -->
                            ...
                            <div class="d-flex order-lg-2 ms-auto header-right-icons">
                                ...
                                <div class="dropdown d-flex profile-1"> <a href="#" data-bs-toggle="dropdown" class="nav-link leading-none d-flex">
                                        <img src="<?php echo e(url('assets/images/users/21.jpg')); ?>" alt="profile-user" class="avatar  profile-user brround cover-image"> </a>
                                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                        <div class="drop-heading">
                                            <div class="text-center">
                                                <h5 class="text-dark mb-0 fs-14 fw-semibold"> <?php echo e(Auth::guard('admin')->user()->name); ?> </h5> <small class="text-muted"> <?php echo e(Auth::guard('admin')->user()->email); ?> </small>
                                            </div>
                                        </div>
                                        ...
                                        <a class="dropdown-item" href="<?php echo e(route('admin.setting.admin')); ?>"> <i class="dropdown-icon fa fa-key"></i> Change Password </a>
                                        <button class="dropdown-item" id="logout" data-url="<?php echo e(route('admin.logout')); ?>"> <i class="dropdown-icon fa fa-sign-out"></i> Logout </button>
                                    </div>
                                </div>
                    ...
                    <div class="app-sidebar ps open">
                        <div class="side-header">
                            <a class="header-brand1" href="<?php echo e(route('admin.dashboard')); ?>">
                                <img src="<?php echo e(url('storage/logo',$site_details->logo)); ?>" style="width: 50px;" class="header-brand-img desktop-logo" alt="logo">
                                <img src="<?php echo e(url('storage/logo',$site_details->logo)); ?>" style="width: 50px;" class="header-brand-img toggle-logo" alt="logo">
                                <img src="<?php echo e(url('storage/logo',$site_details->logo)); ?>" style="width: 50px;" class="header-brand-img light-logo" alt="logo">
                                <img src="<?php echo e(url('storage/logo',$site_details->logo)); ?>" style="width: 50px;" class="header-brand-img light-logo1" alt="logo">
                            </a> <!-- LOGO -->
                        </div>
                        <div class="main-sidemenu is-expanded">
                            ...
                            <ul class="side-menu open">
                                ...
                                <li class="slide"> <a class="side-menu__item" data-bs-toggle="slide" href="<?php echo e(route('admin.order')); ?>"><i class="side-menu__icon fe fe-truck"></i><span class="side-menu__label">Order</span></a> </li>
                                <li class="slide"> <a class="side-menu__item" data-bs-toggle="slide" href="<?php echo e(route('admin.user.index')); ?>"><i class="side-menu__icon fe fe-user"></i><span class="side-menu__label">Users</span></a> </li>
                                ...
                                <li class="slide"> <a class="side-menu__item" data-bs-toggle="slide" href="#"><i class="side-menu__icon fa fa-product-hunt"></i><span class="side-menu__label">Product</span><i class="angle fe fe-chevron-right"></i></a>
                                    <ul class="slide-menu">
                                        ...
                                        <li><a href="<?php echo e(route('admin.product.create')); ?>" class="slide-item">Add</a></li>
                                        <li><a href="<?php echo e(route('admin.product.index')); ?>" class="slide-item">View</a></li>
                                    </ul>
                                </li>
                                <li class="slide"> <a class="side-menu__item" data-bs-toggle="slide" href="#"><i class="side-menu__icon fe fe-box"></i><span class="side-menu__label">Package</span><i class="angle fe fe-chevron-right"></i></a>
                                    <ul class="slide-menu">
                                        ...
                                        <li><a href="<?php echo e(route('admin.kit.create')); ?>" class="slide-item">Add</a></li>
                                        <li><a href="<?php echo e(route('admin.kit.index')); ?>" class="slide-item">View</a></li>
                                    </ul>
                                </li>
                                <li class="slide"> <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"> <i class="side-menu__icon fe fe-cpu"></i> <span class="side-menu__label">Blogs</span><i class="angle fe fe-chevron-right"></i></a>
                                    <ul class="slide-menu" style="display: none;">
                                        ...
                                        <li><a href="<?php echo e(route('admin.blog.create')); ?>" class="slide-item">Add</a></li>
                                        <li><a href="<?php echo e(route('admin.blog.index')); ?>" class="slide-item">View</a></li>
                                        <li class="sub-slide"> <a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="javascript:void(0)"><span class="sub-side-menu__label">Category</span><i class="sub-angle fe fe-chevron-right"></i></a>
                                            <ul class="sub-slide-menu" style="display: none;">
                                                <li><a href="<?php echo e(route('admin.blogcategory.create')); ?>" class="sub-slide-item2">Add</a></li>
                                                <li><a href="<?php echo e(route('admin.blogcategory.index')); ?>" class="sub-slide-item2">View</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </li>
                                <li class="slide"> <a class="side-menu__item" data-bs-toggle="slide" href="#"><i class="side-menu__icon fa fa-newspaper-o"></i><span class="side-menu__label">News</span><i class="angle fe fe-chevron-right"></i></a>
                                    <ul class="slide-menu">
                                        ...
                                        <li><a href="<?php echo e(route('admin.news.create')); ?>" class="slide-item">Add</a></li>
                                        <li><a href="<?php echo e(route('admin.news.index')); ?>" class="slide-item">View</a></li>
                                    </ul>
                                </li>
                                <li class="slide"> <a class="side-menu__item" data-bs-toggle="slide" href="#"><i class="side-menu__icon fa fa-sliders"></i><span class="side-menu__label">Slider</span><i class="angle fe fe-chevron-right"></i></a>
                                    <ul class="slide-menu">
                                        ...
                                        <li><a href="<?php echo e(route('admin.slider.create')); ?>" class="slide-item">Add</a></li>
                                        <li><a href="<?php echo e(route('admin.slider.index')); ?>" class="slide-item">View</a></li>
                                    </ul>
                                </li>
                                <li class="slide"> <a class="side-menu__item" data-bs-toggle="slide" href="#"><i class="side-menu__icon fa fa-picture-o"></i><span class="side-menu__label">Gallery</span><i class="angle fe fe-chevron-right"></i></a>
                                    <ul class="slide-menu">
                                        ...
                                        <li><a href="<?php echo e(route('admin.gallery.create')); ?>" class="slide-item">Add</a></li>
                                        <li><a href="<?php echo e(route('admin.gallery.index')); ?>" class="slide-item">View</a></li>
                                    </ul>
                                </li>
                                <li class="slide"> <a class="side-menu__item" data-bs-toggle="slide" href="#"><i class="side-menu__icon fa fa-question-circle-o"></i><span class="side-menu__label">Faqs</span><i class="angle fe fe-chevron-right"></i></a>
                                    <ul class="slide-menu">
                                        ...
                                        <li><a href="<?php echo e(route('admin.faqs.create')); ?>" class="slide-item">Add</a></li>
                                        <li><a href="<?php echo e(route('admin.faqs.index')); ?>" class="slide-item">View</a></li>
                                    </ul>
                                </li>
                                <li class="slide"> <a class="side-menu__item" data-bs-toggle="slide" href="#"><i class="side-menu__icon fa fa-file-o"></i><span class="side-menu__label">Pages</span><i class="angle fe fe-chevron-right"></i></a>
                                    <ul class="slide-menu">
                                        ...
                                        <li><a href="<?php echo e(route('admin.page.create')); ?>" class="slide-item">Add</a></li>
                                        <li><a href="<?php echo e(route('admin.page.index')); ?>" class="slide-item">View</a></li>
                                    </ul>
                                </li>
                                ...
                                <li class="slide"> <a class="side-menu__item" data-bs-toggle="slide" href="#"><i class="side-menu__icon mdi mdi-cash-100"></i><span class="side-menu__label">Debit Request</span><i class="angle fe fe-chevron-right"></i></a>
                                    <ul class="slide-menu">
                                        ...
                                        <li><a href="<?php echo e(route('admin.debit.user')); ?>" class="slide-item">Add Request</a></li>
                                        <li><a href="<?php echo e(route('admin.debit.index')); ?>" class="slide-item">View Request</a></li>
                                    </ul>
                                </li>

                                <li> <a class="side-menu__item" href="<?php echo e(route('admin.enquery.index')); ?>"><i class="side-menu__icon fa fa-check-square-o"></i><span class="side-menu__label">Enquery</span></a> </li>
                                <li> <a class="side-menu__item" href="<?php echo e(route('admin.support.index')); ?>"><i class="side-menu__icon zmdi zmdi-help-outline"></i><span class="side-menu__label">Support</span></a> </li>
                                <li> <a class="side-menu__item" href="<?php echo e(route('admin.tdstransfer.index')); ?>"><i class="side-menu__icon mdi mdi-cash-100"></i><span class="side-menu__label">TDS Transfer</span></a> </li>
                                <li> <a class="side-menu__item" href="<?php echo e(route('admin.email.index')); ?>"><i class="side-menu__icon fe fe-mail"></i><span class="side-menu__label">Send Email</span></a> </li>
                                <li class="sub-category">
                                    <h3>General</h3>
                                </li>
                                ...
                                <li class="slide"> <a class="side-menu__item" data-bs-toggle="slide" href="#"><i class="side-menu__icon fe fe-award"></i><span class="side-menu__label">Rewards</span><i class="angle fe fe-chevron-right"></i></a>
                                    <ul class="slide-menu">
                                        ...
                                        <li><a href="<?php echo e(route('admin.reward.create')); ?>" class="slide-item">Add</a></li>
                                        <li><a href="<?php echo e(route('admin.reward.index')); ?>" class="slide-item">View</a></li>
                                        <li><a href="<?php echo e(route('admin.reward.user')); ?>" class="slide-item">User</a></li>
                                    </ul>
                                </li>
                                ...
                                <li> <a class="side-menu__item" href="#" id="logout" data-url="<?php echo e(route('admin.logout')); ?>"><i class="side-menu__icon fa fa-sign-out"></i><span class="side-menu__label">Logout</span></a> </li>
                ...
                <!--/APP-SIDEBAR-->
                <!-- <div class="jumps-prevent" style="padding-top: 74px;"></div> --><?php /**PATH /home2/vijaycku/public_html/resources/views/backend/common/header.blade.php ENDPATH**/ ?>