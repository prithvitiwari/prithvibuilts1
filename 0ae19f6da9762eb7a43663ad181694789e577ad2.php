...
<?php $__env->startSection('keywords', 'Cart Keywords'); ?>
<?php $__env->startSection('description', 'Cart Description'); ?>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xl-8">
                    <div class="card cart">
                        ...
                        <?php echo e(Form::open(['url' => route('user.cart.update'), 'method'=>'POST', 'files' => true, 'class' => ''])); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class=" d-flex g-2">
                                                    <a href="<?php echo e(route('user.cart.delete',$list->id)); ?>" class="btn text-danger bg-danger-transparent btn-icon py-1" data-bs-toggle="tooltip" data-bs-original-title="Delete">
                ...
                <div class="col-lg-12 col-xl-4 col-sm-12 col-md-12">
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <div class="btn-list">
                                <a href="<?php echo e(route('user.cart.checkout')); ?>" class="btn btn-success float-sm-end">Submit<i class="fa fa-arrow-right ms-1"></i></a>
                            </div>
                        </div>
                        <?php endif; ?>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layout.usermaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/vijaycku/public_html/resources/views/frontend/inc/user/cart.blade.php ENDPATH**/ ?>