...
<div class="page">
    <div class="">
        ...
        <div class="col col-login mx-auto mt-7">
            <div class="text-center"> <img src="{{ url('storage/logo',$setting->logo) }}" style="width: 100px;" class="header-brand-img" alt=""> </div>
        </div>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab5">
                                    ...
                                    <div class="container-login100-form-btn">
                                        ...
                                        <!-- <a href="{{ route('admin.dashboard') }}" class="login100-form-btn btn-primary"> Login </a> -->
                                    </div>
