                            ...
                            <div class="table-responsive">
                                ...
                                <form class="needs-validation">
                                    <div class="d-flex">
                                        ...
                                        <div style="margin-right: 10px;"><a href="<?php echo e(route('admin.email.user',$user->id)); ?>" class="btn btn-danger" style="background-color: #e74c3c;">Clear All</a></div>
                                    </div>
                                </form>
                                    ...
                                    <table class="table border text-nowrap text-md-nowrap table-bordered mb-0 mt-5">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if($list->attechment): ?>
                                                    <a href="<?php echo e(url('storage')); ?>/<?php echo e($list->attechment); ?>" target="_blank"><i class="fa fa-link"></i> Attach</a>
                                                    <?php else: ?>
                                                    N/A
                                                    <?php endif; ?>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="btn-list">
                                                        <a href="#" data-url="<?php echo e(route('admin.email.delete',$list->id)); ?>" id="single_delete" class="btn btn-sm btn-danger">
...
<?php $__env->stopSection(); ?><?php /**PATH /home2/vijaycku/public_html/resources/views/backend/inc/email/user.blade.php ENDPATH**/ ?>